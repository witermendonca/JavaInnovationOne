...
public class FutureExemplo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<Future<String>> futuros = new CopyOnWriteArrayList<>(
				casa.obterAfazeresDaCasa().stream().map(atividade -> pessoasParaExecutarAtividade.submit(() -> {
					try {
...
class Quarto extends Comodo {
	...
	List<Atividade> obterAfazeresDoComodo() {
		...
		return Arrays.asList(this::arrumarACama, this::varretOQuarto, this::arrumarGuardaRoupa);
	}
