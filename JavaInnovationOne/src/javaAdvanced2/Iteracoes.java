...
public class Iteracoes {
	...
	public static void main(String[] args) {
		...
		String[] nomes = { "Joao", "Fabio", "Paulo", "Oliveira", "Tiago", "Vitor", "Joca" };
		...
		imprirmirODobroDeCadaItemDaLista(numeros);
		 ...
		 profissoes.stream().filter(profissao ->
		 profissao.startsWith("Gerente")).forEach(System.out::println);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		String nomesResultados = Stream.of(nomes).filter(nome -> nome.equals("Joao")).collect(Collectors.joining());
